...
<script>
    ...
    export default {
        ...
        methods:{
            show: function() {
                axios.post(`/api/admin/status/get/${this.$route.params.id}`).then(function(response) {
            ...
            async update() {
                if (
                    ...
                    axios.post(`/api/admin/status/update/${this.$route.params.id}`, fd, config).then(function(response){
