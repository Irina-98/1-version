...
<script>
    ...
    export default {
        ...
        methods:{
            show: function() {
                axios.post(`/api/admin/relationship/get/${this.$route.params.id}`).then(function(response) {
            ...
            async update() {
                if (
                    ...
                    axios.post(`/api/admin/relationship/update/${this.$route.params.id}`, fd, config).then(function(response){
                        this.$router.push({name:"AdminRelationshipList"})
                    }.bind(this));
                }
            },
        },
