...
<script>
    ...
    export default {
        ...
        methods:{
            show: function() {
                axios.post(`/api/admin/education/get/${this.$route.params.id}`).then(function(response) {
            ...
            async update() {
                if (
                    ...
                    axios.post(`/api/admin/education/update/${this.$route.params.id}`, fd, config).then(function(response){
                        this.$router.push({name:"AdminEducationList"})
                    }.bind(this));
                }
            },
        },
