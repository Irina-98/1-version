...
<script>
    ...
    export default {
        ...
        methods:{
            show: function() {
                axios.post(`/api/admin/lesson/get/${this.$route.params.id}`).then(function(response) {
            ...
            async update() {
                if (
                    ...
                    axios.post(`/api/admin/lesson/update/${this.$route.params.id}`, fd, config).then(function(response){
                        this.$router.push({name:"AdminLessonList"})
                    }.bind(this));
                }
            },
        },
