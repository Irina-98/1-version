    ...
    <v-app light>
        ...
        <v-main>
            ...
            <v-row dense>
                ...
                >
                <v-card v-if="($refs.menu.me != null) && ($refs.menu.me.user != null)">
                    <a :href="`${r.portal.link_external_login + 
                        '?etoken=' + $refs.menu.me.user.etokens[0].etoken +
                        '&email=' + $refs.menu.me.user.email}`"
                        target="blank"
                    >
                        <v-img
                        type="submit"
